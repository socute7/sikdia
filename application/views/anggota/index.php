                    ...
                    <table class="table table-hover" id="dtHorizontalExample" width="100%" cellspacing="0">
                        ...
                        <tbody style="cursor:pointer;" id="tbody"> 
                            ...
                            <tr>
                                ...
                                <td onclick="detail('<?= $a->id_anggota ?>')"><?= $a->jabatan ?></td>
                                <td onclick="detail('<?= $a->id_anggota ?>')"><?= $a->penggunaan ?></td>
                                <td onclick="detail('<?= $a->id_anggota ?>')"><?= $a->jenis ?></td>
                                <td onclick="detail('<?= $a->id_anggota ?>')"><?= $a->tujuan ?></td>
                                <td onclick="detail('<?= $a->id_anggota ?>')"><?= $a->notelp ?></td>
                                <td onclick="detail('<?= $a->id_anggota ?>')"><?= $a->divisi ?></td>
