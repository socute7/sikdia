...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="d-sm-flex">
            ...
            &nbsp;
            <h1 class="h2 mb-0 text-gray-800">Detail mobil</h1>
        </div>
        <!-- 
                ...
                <div class="card-body d-sm-flex">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="form-group"><label>ID mobil</label>
                            <h4 class="h4 text-gray-800"><b><?= $d->id_mobil ?></b></h4>
                        </div>
                        ...
                        <!-- Judul mobil -->
                        <div class="form-group"><label>Judul mobil</label>
                        ...
                        <!-- Jumlah mobil -->
                        <div class="form-group"><label>Jumlah mobil</label>
