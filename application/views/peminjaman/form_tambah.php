    ...
    <form action="<?= base_url() ?>peminjaman/proses_tambah" name="myForm" method="POST" enctype="multipart/form-data"
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <div class="d-sm-flex">
                ...
                &nbsp;
                <h1 class="h2 mb-0 text-gray-800">Peminjaman mobil</h1>
            </div>
            ...
            <div class="col-lg">
                <div class="card border-bottom-primary shadow mb-4">
                    <div class="card-header py-3 d-sm-flex justify-content-between bg-primary">
                        <h6 class="m-0 font-weight-bold text-white">Mobil yg Dipinjam</h6>
                        <div class="d-sm-flex">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    <select name="mobil" class="form-control chosen" id="mobil">
                                        <option selected value="">--Pilih mobil--</option>
                                        <?php foreach($mobil as $b): ?>
                                            <option value="<?= $b->id_mobil ?? '' ?>">[<?= $b->id_mobil ?? '' ?>] <?= $b->merk ?? '' ?></option>
