    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>home">
                ...
                <div class="sidebar-brand-text mx-3 ">SIKIDA <sup><b>WEB</b></sup></div>
            ...
            <?php if($title == 'mobil' or $title == 'Kategori'): ?>
            <li class="nav-item active">
                <?php else: ?>
            <li class="nav-item">
                <?php endif; ?>
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="<?= base_url() ?>mobil">Mobil</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="<?= base_url() ?>peminjaman">Peminjaman</a>
                        <a class="collapse-item active" href="<?= base_url() ?>pengembalian">Pengembalian</a>
                    </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages2" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="<?= base_url() ?>lapeminjaman">Peminjaman mobil</a>
                    </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Nama Aplikasi 
                    <h1 class="h3 mb-0 text-gray-800"><b>SIKIDA</b></h1>
                    -->
